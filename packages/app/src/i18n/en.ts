export const dict = {
  ...
  "dialog.provider.opencode.note": "Sarvam-first setup tuned for Kode's core coding flow",
  "dialog.provider.opencode.tagline": "Fast curated coding models",
  ...
  "dialog.provider.openrouter.note": "Use your Sarvam key to unlock Kode's supported models",
  ...
  "error.chain.checkConfig": "Check your config (opencode.json) provider and model names",
