export const dict = {
  ...
  "desktop.menu.help.documentation": "Kode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Kode CLI binary is missing. Try reinstalling the desktop app.",
